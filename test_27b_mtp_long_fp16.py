...
def main():
    ...
    print(f"LONG_MTP_FP16: in={n_in} out={n_out} decode={n_out / dt:.1f} tok/s")
    print("OUTPUT_HEAD:", repr(out[0].outputs[0].text[:200]))
    print("OUTPUT_TAIL:", repr(out[0].outputs[0].text[-200:]))
