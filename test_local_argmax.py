"""Measure MTP throughput with use_local_argmax_reduction."""
import os, sys, time

os.environ["VLLM_MEMORY_PROFILER_ESTIMATE_CUDAGRAPHS"] = "0"

LOG = "/data/src/vllm/test_local_argmax.log"
...
if __name__ == '__main__':
    with open(LOG, "w") as log:
        try:
            ...
            log.write(f"MIN: {min(results):.1f} tok/s\n")
            log.write(f"MAX: {max(results):.1f} tok/s\n")
