"""A/B vs test_run.py: disable V1 multiprocessing to test whether engine-core
IPC is the ~80ms/step host stall seen in nsys."""
import os, time
os.environ["VLLM_MEMORY_PROFILER_ESTIMATE_CUDAGRAPHS"] = "0"
os.environ["VLLM_ENABLE_V1_MULTIPROCESSING"] = "0"

LOG = "/data/src/vllm/bench_result_mp0.log"
