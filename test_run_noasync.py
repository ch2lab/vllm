"""A/B: disable async scheduling to test whether the ~54ms inter-step stall
comes from the async pipeline (event-sync chaining across ranks)."""
import os, time
os.environ["VLLM_MEMORY_PROFILER_ESTIMATE_CUDAGRAPHS"] = "0"

LOG = "/data/src/vllm/bench_result_noasync.log"
